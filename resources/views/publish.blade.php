...
<head>
    ...
    <title>{{env('APP_NAME')}} - Publish Post</title>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <form name="sentMessage" method="POST" novalidate enctype="multipart/form-data">
                @csrf
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>Content</label>
                        <textarea name="body" class="form-control" rows="6" placeholder="post content"></textarea>
                        <p class="help-block text-danger"></p>
                    </div>
                </div>
